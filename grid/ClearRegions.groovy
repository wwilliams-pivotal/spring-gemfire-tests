 ...
 * You can enter a comma-delimited string of region names.
 * This command supports regex expressions in the region names
 */

// parse the command line args for a locator and regions using Apache CliBuilder
def cl = new CliBuilder(usage: 'groovy -cp $GEMFIRE/lib/server-dependencies.jar ClearRegions -l "locatorHost" -p "nnnnn"  [regions]*')
...
ResultCollector rc = execution.execute("ClearRegionsFunction");
